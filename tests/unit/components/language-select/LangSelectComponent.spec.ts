...
describe('+ LangSelectComponent.vue tests', () => {
  ...
  it('Should append the available classes', () => {
    expect(wrapper.classes()).toEqual(['font-semibold', 'text-gray-600', 'lg:text-gray-800', 'bg-transparent', 'text-base', 'lg:appearance-none', 'lg:w-10/12', 'text-center', 'outline-gray-300', 'cursor-pointer', 'capitalize' ]);
  });
